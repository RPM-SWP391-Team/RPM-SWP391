...
public class DoctorController {
    ...
    // GET http://localhost:8080/api/doctor/patients/search?keyword=09
    ...
    public ResponseEntity<List<PatientSearchResponseDTO>> searchPatients(
        ...
        List<PatientSearchResponseDTO> patients =
                doctorPatientService.searchUnassignedPatients(keyword, doctor.getHospital().getId());
        return ResponseEntity.ok(patients);
    }

    // API 2: Gán bệnh nhân vào bác sĩ — doctorId lấy từ session, không nhận từ client
    // POST http://localhost:8080/api/doctor/patients/assign
    ...
    public ResponseEntity<String> assignPatient(
        ...
        String message = doctorPatientService.assignPatient(
                ...
                doctor.getId(),              // ← từ session, không phải request body
