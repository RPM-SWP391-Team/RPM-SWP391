...
public class Appointment03Test {
    ...
    void testExecute() {
        ...
        page.selectOption("#doctorId", new SelectOption().setIndex(1));

        // Step 10: Select Appointment Time (Future date)
        // Format: yyyy-MM-ddTHH:mm
        LocalDateTime tomorrow = LocalDateTime.now().minusDays(1).withHour(9).withMinute(0);
